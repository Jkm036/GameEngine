...
int main() {
	...
	//Layer 1
	Sparky::Graphics::Texture* texA = new Sparky::Graphics::Texture ("test.png");
	Sparky::Graphics::Texture* texB = new Sparky::Graphics::Texture("b.png");
	...
	for (float y = -9.0f; y < 9.0f; ++y) {
		for (float x = -16.0f; x < 16.0f; ++x) {
			...
			background.add(new Sparky::Graphics::Sprite(x, y, 0.9f, 0.9f,rand() % 2 == 0 ? texA:texB));
		}
	}
